...
class Animal {
   ...
   public:
    ...
    Animal(const string& name) : species_name(name) { cout << "Animal constructor called" << endl; }
...
class Mammal : virtual public Animal {
   public:
    ...
    Mammal(const string& name) : Animal(name) { cout << "Mammals constructor called" << endl; }
};
