...
class IntPtrManager {
 public:
  ...
  IntPtrManager() {
    // private member pointer to integer.
    ptr_ = new int;  // allocate memory for an integer in heap
    *ptr_ = 0;       // set the value of the integer to 0
  }
...
int main() {
  ...
  // Note: after this, a is no longer valid
